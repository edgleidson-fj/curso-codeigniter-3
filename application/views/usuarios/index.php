                                            ...
                                            <tbody>
												<?php foreach ($usuarios as $u): ?>
													<tr>
														...
														<td>
															<a data-toggle="tooltip" data-placement="bottom" title="Editar <?php echo $this->router->fetch_class(); ?>" href="<?php echo base_url('usuarios/core/'.$u->id); ?>" class="btn btn-icon btn-primary"><i class="ik ik-edit-2"></i></a> <!-- Botão Editar-->
